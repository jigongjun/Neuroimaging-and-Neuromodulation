...
%          imwrite (I.cdata,[DTIdir,filesep,outfd,filesep,[trackname{1,kk} '.bmp']]);
  ...
  load([DTIdir,filesep,'TractRes',filesep,strcat(imgname{1}, '.mat')]) ;
  mkdir([DTIdir,filesep,['Track' imgname{1} 'QC']]) ;  
  outfd = ['Track' imgname{1} 'QC'] ;
  MsImgList = dir([FunDir,filesep,[imgname{1} '*.nii']]);
